...
As stated in the paper, applications which do not employ standard synchronization primities (such as pthread or libpmemobj's mutexes), require a configuration file with information regarding each primitive.
